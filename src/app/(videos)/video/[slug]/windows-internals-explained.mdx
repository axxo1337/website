...
![Basic digital data sizes|center|800px](/images/documents/windows-internals-explained/data_basic_sizes.png)
...
![Protection rings|center|400px](/images/documents/windows-internals-explained/protection_rings.png)
...
![Overview of a CPU architecture|center|1920px](/images/documents/windows-internals-explained/cpu_overview.png)
...
![Windows architecture simplified|center|800px](/images/documents/windows-internals-explained/win_arch_simple.png)
...
![Binary Ninja decompilation KiSystemCall64|center|800px](/images/documents/windows-internals-explained/ki_syscall64_decomp.png)
...
![Binary Ninja decompilation KiSystemServiceStart|center|800px](/images/documents/windows-internals-explained/ki_systemservice_start_decomp.png)
...
![Binary Ninja decompilation KiSystemCall64_Hook|center|800px](/images/documents/windows-internals-explained/ki_syscall64_hook_decomp.png)
...
<UndocumentedStruct title="_SECURITY_DESCRIPTOR" source="https://www.vergiliusproject.com/kernels/x64/windows-11/25h2/_SECURITY_DESCRIPTOR">
...
![_ACE mask|center|800px](/images/documents/windows-internals-explained/ace_mask.png)
...
<MicrosoftLearnQuote title="CreateFileA" description="Creates or opens a file or I/O device. The function returns a handle that can be used to access the file or device for various types of I/O depending on the file or device and the flags and attributes specified." source="https://learn.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-createfilea">
{`HMODULE CreateFileA(
...
<MicrosoftLearnQuote title="CreateFileW" description="Creates or opens a file or I/O device. The function returns a handle that can be used to access the file or device for various types of I/O depending on the file or device and the flags and attributes specified." source="https://learn.microsoft.com/en-us/windows/win32/api/fileapi/nf-fileapi-createfilew">
{`HMODULE CreateFileW(
...
<MicrosoftLearnQuote title="CreateFileMappingA" description="Creates or opens a named or unnamed file mapping object for a specified file." source="https://learn.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-createfilemappinga">
...
![Binary Ninja CreateFileMappingW decompilation|center|800px](/images/documents/windows-internals-explained/createfilemappingw_decomp.png)
