    ...
    >
      <Section subtitle="What's this about?" title="Overview">
        <p className="md:text-lg">
          ...
          (a good lad) pointed out, it may mislead people into thinking I&apos;m
          affiliated to whatever I put here. So unless specified otherwise
          I&apos;m not. Anything I put here is purely to list helpful resources
          which I may or may not have used in my previous work. All that matters
      ...
      <Section subtitle="Some advice and links" title="Material">
        ...
        <p>
          ...
          is. Although since I know that many don&apos;t find reading for
        ...
        <ul className="list-disc pl-5 flex flex-col gap-2 my-1">
          ...
          <li>
            ...
            . While it&apos;s a good introduction I doesn&apos;t seem to really
            go far through C++. I would still rely on other resources.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-5 flex flex-col gap-2 my-1">
          <li>
            ...
            . This is an unavoidable series. After reading it I wouldn&apos;t
            say it&apos;s GREAT, but it being the only one of its kind it should
            be in your library.
          </li>
          <li>
            ...
            . An amazing book by one of the co-authors of the Windows Internals
            book series. You can clearly see that the bad parts of that series
            are not his fault by reading this great creation.
          </li>
          <li>
            <a
            ...
            . A convenient database of present and past undocumented kernel
            structures from the Windows kernel.
          </li>
        </ul>
        ...
        <p>
          ...
          Intel assembly. If you&apos;re working with desktop devices
          that&apos;s what you&apos;ll likely need. Overall, while this subject
          relies heavily on prerequisite theory, it&apos;s hard to really
        ...
        <ul className="list-disc pl-5 flex flex-col gap-2 my-1">
          <li>
            ...
            . There aren&apos;t many existing resources to learn assembly. This
            one should at least get you through the fundamentals you need.
          </li>
          <li>
            <a
              href="https://en.wikipedia.org/wiki/Reversing:_Secrets_of_Reverse_Engineering"
              className="inline-anchor"
            >
              Reversing: Secrets of Reverse Engineering
            </a>
            . An amazing book which got me started back in my younger days. Some
            of its contents are a little out of date, but I still think most of
            it is very relevant now and in the future.
          </li>
        </ul>
      </Section>
      <Socials />
