...
export default function SubscribeCTA() {
  return (
    <div className="relative isolate mt-12 flex flex-col items-center gap-5 overflow-hidden rounded-2xl border border-white/10 px-4 py-10 text-center sm:gap-6 sm:px-7">
