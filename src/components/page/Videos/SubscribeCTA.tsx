...
export default function SubscribeCTA() {
  return (
    <div className="relative isolate mt-10 sm:mt-12 flex flex-col items-center gap-5 overflow-hidden rounded-2xl border border-white/10 px-3 py-7 text-center sm:gap-6 sm:py-10 sm:px-7">
