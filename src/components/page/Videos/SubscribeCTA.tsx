  ...
  return (
    <div className="relative isolate mt-10 sm:mt-12 group flex flex-col items-center gap-5 overflow-hidden rounded-2xl border border-white/20 px-3 py-7 text-center sm:gap-6 sm:py-10 sm:px-7 blured-bg">
      ...
      <Link
        ...
        className="flex items-center gap-2.5 rounded-lg bg-red-600 px-5 py-3 font-semibold text-sm hover:bg-red-400 transition-colors"
      >
      ...
      <Image
        ...
        width={160}
        height={204.33}
        className="absolute -z-10 -bottom-11.5 -left-7.5 sm:-bottom-15.5 sm:-left-10.5 w-30 sm:w-40 sm:group-hover:-left-9 sm:group-hover:-bottom-13 rotate-45 select-none pointer-events-none brightness-50 transition-all group-hover:brightness-75 ease-in-out"
      />
    </div>
  );
}
