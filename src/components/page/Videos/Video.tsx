      ...
      <article>
        <AspectRatio ratio={16 / 9} className="relative overflow-hidden rounded-sm border-2 border-white/20 bg-black">
          ...
          {statusObject && (
            <div
              className={cn(
                "absolute top-0 left-0 backdrop-blur-sm px-2 py-1 backdrop-brightness-35 rounded-br-md flex justify-between items-center border-r border-b group-hover:opacity-0 opacity-100 duration-250 transition-opacity",
