  ...
  const renderContent = () => (
    <Fragment>
      <Image
        ...
        aria-hidden="true"
      />
      <span className="font-medium -top-px text-lg md:text-xl group-hover:text-white/80 transition-colors duration-250 group-hover-underline flex items-center gap-2">
        {title}
      </span>
    </Fragment>
  );
